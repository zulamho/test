...
const FilesList = ({anchors, anchorsObject, isReadyToShow, filesUploadingStatus, setCurrentMenuIndex, activeFilesStructure, isAnchorChoosingActive, setChoosedAnchors, setChoosedDir, setIsFilesBottomSheetVisible, scrollY}) => {
